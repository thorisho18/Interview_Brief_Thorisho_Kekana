...
<body class="body">
						...
						<div class="header__content">
							...
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									<a class="dropdown-toggle header__nav-link" href="index.html" role="button" id="dropdownMenuHome" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
								<li class="header__nav-item">
									<a href="index.html" class="header__nav-link">Movies</a>
								</li>
							...
							<div class="header__auth">
								...
								<a href="" class="header__sign-in"><i class="icon ion-ios-log-in"></i>
									<span>Log In</span>
								</a>
							</div>
	...
	<section class="home">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h1 class="home__title"><b>Kids Movies</h1>
		...
		<div class="content__head">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<!-- content title -->
						<h2 class="content__title">Kids Movies</h2>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-sm-4 col-md-3">
					...
					<ul class="footer__list">
						<li><a href="tel:+27 79 943 9325">+27 79 943 9325</a></li>
						<li><a href="mailto:thorishokekana@gmail.com">thorishokekana@gmail.com</a></li>
					</ul>
